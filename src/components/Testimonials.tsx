      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-accent/10 rounded-full px-6 py-3 mb-6">
            <Star className="w-5 h-5 text-[#b69532]" />
            <span className="text-[#b69532] font-semibold">Success Stories</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
            Real Results from 
            <span className="text-[#b69532]"> Real Realtors</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            See how our platform has transformed the careers of real estate professionals across the GTA.
          </p>
        </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center space-x-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 text-[#b69532] fill-current" />
                  ))}
                </div>
                ...
                <div className="flex items-center space-x-4 mb-4 text-sm">
                  <div className="bg-accent/10 rounded-lg px-3 py-2">
                    <span className="text-[#b69532] font-semibold">{testimonial.revenue}</span>
                    <span className="text-muted-foreground ml-1">revenue</span>
                  </div>
                  <div className="bg-secondary/10 rounded-lg px-3 py-2">
                    <span className="text-[#b69532] font-semibold">+{testimonial.increase}</span>
